...
const string swaggerRoutePrefix = "shipments/swagger";
...
builder.Services.AddSingleton<InternalRequestAuthenticator>();
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Shipment aggregate owner service for the logistics platform."
    });
...
if (swaggerEnabled)
{
    ...
    app.UseSwaggerUI(options =>
    {
        ...
        options.SwaggerEndpoint("v1/swagger.json", "shipment-service API v1");
    });
}
